...
npm install
```
3. Create a .env file in backend/ with these variables (see [Enviroment Variables](#inviomentvVariables) below). For example:
```bash
...
npm start
```
The default runs on http://localhost:3000/ by default.
